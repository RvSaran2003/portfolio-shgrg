    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm  Shrey Garg</p>
            <p className="subtext">
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I specialize in multiple languages and frameworks—including C++, Python, JavaScript, React, Next.js, and Node.js—to build scalable, robust applications. Experienced with databases like MongoDB and MySQL, and tools such as Git, Firebase, and Figma, I deliver efficient full-stack solutions with a focus on AI integration and seamless user experiences.
            </p>
          </div>
